...
class ManualXAxisPopup(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.start_auto_checkbox.setAccessibleName("Use automatic X-axis start from Data range")
        self.end_auto_checkbox.setAccessibleName("Use automatic X-axis end from Data range")
